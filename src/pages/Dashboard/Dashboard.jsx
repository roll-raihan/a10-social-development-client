            ...
            <div className="drawer-side is-drawer-close:overflow-visible">
                ...
                <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
                    ...
                    <ul className="menu w-full grow">
                        ...
                        <li>
                            <Link to='/createEvent' className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Create Event">
                                {/* Home icon */}
                        ...
                        <li>
                            <Link to='/manageEvent' className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Manage Event">
                                <FaTasks></FaTasks>
